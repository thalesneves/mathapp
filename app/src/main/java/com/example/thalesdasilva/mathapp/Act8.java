...
public class Act8 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 8;
                ...
                new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        ...
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString() + getString(R.string.btnX) +
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act8.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act8.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa8() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act8.this, ActPausa8.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é " +
                    TXT_NUM_1.getText().toString() + getString(R.string.btnX) + TXT_NUM_2.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act8.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act8.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act8.this, "Erro", "Erro");
        }
    }
