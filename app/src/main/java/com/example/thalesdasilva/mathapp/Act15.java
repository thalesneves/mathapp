...
public class Act15 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 15;
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            if (TXT_SINAL.getText().toString().equals("+")) {
                                TEXT_TO_SPEECH.speak("Quanto é" + String.valueOf(numeroRandomico1) + getString(R.string.btnX) +
                                                String.valueOf(numeroRandomico2) + " mais " + String.valueOf(numeroRandomico3),
                                        TextToSpeech.QUEUE_FLUSH, null);
                            } else if (TXT_SINAL.getText().toString().equals("-")) {
                                TEXT_TO_SPEECH.speak("Quanto é" + String.valueOf(numeroRandomico1) + getString(R.string.btnX) +
                                                String.valueOf(numeroRandomico2) + " menos " + String.valueOf(numeroRandomico3),
                                        TextToSpeech.QUEUE_FLUSH, null);
                            }
                        }
                    }
    ...
    private void carregarEstrutura() {
        ...
        numeroRandomico2 = (int) (Math.random() * 10);
        ...
        TXT_NUM_3.setText(String.valueOf(numeroRandomico3));
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act15.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void errarSpeak() {
        ...
        if (numeroRandom == 1) {
            TEXT_TO_SPEECH.speak("Infelizmente você errou, o resultado era de " + String.valueOf(RESULTADO_CORRETO),
                    TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 2) {
            TEXT_TO_SPEECH.speak("Não foi dessa vez você errou, o resultado era de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 3) {
            TEXT_TO_SPEECH.speak("Tente mais uma vez, o resultado era de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 4) {
            TEXT_TO_SPEECH.speak("Quem sabe da próxima vez, o resultado era de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 5) {
            TEXT_TO_SPEECH.speak("Que pena tente de novo, o resultado era de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act15.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa15() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act15.this, ActPausa15.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é" + String.valueOf(numeroRandomico1) + getString(R.string.btnX) +
                                String.valueOf(numeroRandomico2) + " mais " + String.valueOf(numeroRandomico3),
                        TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é" + String.valueOf(numeroRandomico1) + getString(R.string.btnX) +
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act15.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act15.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act15.this, "Erro", "Erro no TextSpeech!");
        }
    }
