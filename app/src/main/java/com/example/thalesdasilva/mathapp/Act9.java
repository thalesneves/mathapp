...
public class Act9 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 9;
                ...
                new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            TEXT_TO_SPEECH.speak("Qual valor multiplicado a " + String.valueOf(numeroRandomico1) +
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act9.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void errarSpeak() {
        ...
        if (numeroRandom == 1) {
            TEXT_TO_SPEECH.speak("Infelizmente você errou, o valor multiplicado a" +
            ...
            TEXT_TO_SPEECH.speak("Não foi dessa vez você errou, o valor multiplicado a " +
                    TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                    "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 3) {
            TEXT_TO_SPEECH.speak("Tente mais uma vez, o valor multiplicado a " +
                    TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                    "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 4) {
            TEXT_TO_SPEECH.speak("Quem sabe da próxima vez, o valor multiplicado a " +
                    TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                    "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 5) {
            TEXT_TO_SPEECH.speak("Que pena tente de novo, o valor multiplicado a " +
                    TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                    "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act9.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa9() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act9.this, ActPausa9.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            TEXT_TO_SPEECH.speak("Repetindo a expressão, qual valor multiplicado a " +
                    TXT_NUM_1.getText().toString() + " da o resultado de " +
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act9.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act9.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act9.this, "Erro", "Erro no TextSpeech!");
        }
    }
