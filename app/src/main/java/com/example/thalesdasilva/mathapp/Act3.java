...
public class Act3 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 3;
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act3.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act3.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act3.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
