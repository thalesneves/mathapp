...
public class Act11 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static String        NUMERO_RANDOMICO_2_TXT;
    public static Boolean       VERIFICAR_ONRESUME;
    public static final Integer ID_CLASSE = 11;
    ...
    private String RESULTADO_CORRETOTxt;
                ...
                new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            TEXT_TO_SPEECH.speak("Qual valor dividido a " + TXT_NUM_1.getText().toString() +
                                            " da o resultado de " + String.valueOf(RESULTADO_CORRETOTxt),
    ...
    private void carregarEstrutura() {
        ...
        NUMERO_RANDOMICO_2_TXT = String.format(String.valueOf(df.format(numeroRandomico2))).
                replace(".", ",");

        RESULTADO_CORRETO = numeroRandomico1 / numeroRandomico2;
        RESULTADO_CORRETOTxt = String.format(String.valueOf(df.format(RESULTADO_CORRETO))).
                replace(".", ",");

        TXT_NUM_1.setText(String.valueOf(numeroRandomico1).replace(".0", ""));
        TXT_NUM_2.setText(String.valueOf(RESULTADO_CORRETOTxt).replace(".0", ""));
        ...
        if (numeroAleatorioParaAEscolhaDeQualBotaoASerPreenchido == 1) {
            btnResult1.setText(String.valueOf(NUMERO_RANDOMICO_2_TXT));
            ...
            btnResult2.setText(String.valueOf(NUMERO_RANDOMICO_2_TXT));
            btnResult3.setText(String.valueOf(numeroRandomicoBtnResult3));
            btnResult4.setText(String.valueOf(numeroRandomicoBtnResult4));
            ...
            btnResult1.setText(String.valueOf(numeroRandomicoBtnResult1));
            btnResult2.setText(String.valueOf(numeroRandomicoBtnResult2));
            btnResult3.setText(String.valueOf(NUMERO_RANDOMICO_2_TXT));
            btnResult4.setText(String.valueOf(numeroRandomicoBtnResult4));
            ...
            btnResult2.setText(String.valueOf(numeroRandomicoBtnResult2));
            btnResult3.setText(String.valueOf(numeroRandomicoBtnResult3));
            btnResult4.setText(String.valueOf(NUMERO_RANDOMICO_2_TXT));
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (seconds == 0) {
                            ...
                            TEXT_TO_SPEECH.speak("Seu tempo acabou vamos para o próximo desafio, o valor era de " +
                                            String.valueOf(NUMERO_RANDOMICO_2_TXT),
                                    TextToSpeech.QUEUE_FLUSH, null);
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act11.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void errarSpeak() {
        ...
        if (numeroRandom == 1) {
            TEXT_TO_SPEECH.speak("Infelizmente você errou, o valor era de " +
                    String.valueOf(NUMERO_RANDOMICO_2_TXT), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 2) {
            TEXT_TO_SPEECH.speak("Não foi dessa vez você errou, o valor era de " +
                    String.valueOf(NUMERO_RANDOMICO_2_TXT), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 3) {
            TEXT_TO_SPEECH.speak("Tente mais uma vez, o valor era de " +
                    String.valueOf(NUMERO_RANDOMICO_2_TXT), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 4) {
            TEXT_TO_SPEECH.speak("Quem sabe da próxima vez, o valor era de " +
                    String.valueOf(NUMERO_RANDOMICO_2_TXT), TextToSpeech.QUEUE_FLUSH, null);
        } else if (numeroRandom == 5) {
            TEXT_TO_SPEECH.speak("Que pena tente de novo, o valor era de " +
                    String.valueOf(NUMERO_RANDOMICO_2_TXT), TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act11.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa11() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act11.this, ActPausa11.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            TEXT_TO_SPEECH.speak("Repetindo a expressão, qual valor dividido a " + TXT_NUM_1.getText().toString() +
                    " da o resultado de " + String.valueOf(RESULTADO_CORRETOTxt), TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act11.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act11.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act11.this, "Erro", "Erro no TextSpeech!");
        }
    }
