...
public class Act4 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 4;
    ...
    private void carregarEstrutura() {
        ...
        if (numeroRandom == 1) {
            ...
            TEXT_TO_SPEECH.speak("Qual valor somado a " + String.valueOf(numeroRandomico1) +
                    " da o resultado de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
        ...
        TXT_NUM_2.setText(String.valueOf(RESULTADO_CORRETO));
        ...
        if (numeroAleatorioParaAEscolhaDeQualBotaoASerPreenchido == 1) {
            btnResult1.setText(String.valueOf(numeroRandomico2));
            ...
            btnResult2.setText(String.valueOf(numeroRandomico2));
            btnResult3.setText(String.valueOf(numeroRandomicoBtnResult3));
            btnResult4.setText(String.valueOf(numeroRandomicoBtnResult4));
            ...
            btnResult1.setText(String.valueOf(numeroRandomicoBtnResult1));
            btnResult2.setText(String.valueOf(numeroRandomicoBtnResult2));
            btnResult3.setText(String.valueOf(numeroRandomico2));
            btnResult4.setText(String.valueOf(numeroRandomicoBtnResult4));
            ...
            btnResult2.setText(String.valueOf(numeroRandomicoBtnResult2));
            btnResult3.setText(String.valueOf(numeroRandomicoBtnResult3));
            btnResult4.setText(String.valueOf(numeroRandomico2));
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act4.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void errarSpeak() {
        ...
        if (numeroRandom == 1) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Infelizmente você errou, o valor somado a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Infelizmente você errou, o valor subtraído a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            }
        } else if (numeroRandom == 2) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Não foi dessa vez você errou, o valor somado a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Não foi dessa vez você errou, o valor subtraído a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            }
        } else if (numeroRandom == 3) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Tente mais uma vez, o valor somado a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Tente mais uma vez, o valor subtraído a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            }
        } else if (numeroRandom == 4) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Quem sabe da próxima vez, o valor somado a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Quem sabe da próxima vez, o valor subtraído a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            }
        } else if (numeroRandom == 5) {
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Que pena tente de novo, o valor somado a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Que pena tente de novo, o valor subtraído a " +
                        TXT_NUM_1.getText().toString() + " para dar o valor de " + TXT_NUM_2.getText().toString() +
                        "era de " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
            }
        }
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act4.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa4() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act4.this, ActPausa4.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            ...
            if (TXT_SINAL.getText().toString().equals("+")) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, qual valor somado a " + String.valueOf(numeroRandomico1) + " da o resultado de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals("-")) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, qual valor subtraído a " + String.valueOf(numeroRandomico1) + " da o resultado de " + String.valueOf(RESULTADO_CORRETO), TextToSpeech.QUEUE_FLUSH, null);
            }
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act4.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act4.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act4.this, "Erro", "Erro no TextSpeech!");
        }
    }
