...
public class Act2 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 2;
    ...
    private void carregarEstrutura() {
        ...
        TEXT_TO_SPEECH.speak("Quanto é " + String.valueOf(numeroRandomico1) +
                " menos " + String.valueOf(numeroRandomico2), TextToSpeech.QUEUE_FLUSH, null);
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act2.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 3) {
            ...
            Intent it = new Intent(Act2.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa2() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act2.this, ActPausa2.class);
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act2.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act2.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act2.this, "Erro", "Erro no TextSpeech!");
        }
    }
