...
public class Act14 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    public static final Integer ID_CLASSE = 14;
                ...
                new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString() + " elevado à 2", TextToSpeech.QUEUE_FLUSH, null);
                        }
                    }
                });
    }
    ...
    private void carregarEstrutura() {
        ...
        RESULTADO_CORRETO = (int) Math.pow(numeroRandomico1, 2);
                    ...
                    public void run() {
                        ...
                        if (seconds == 0) {
                            ...
                            TEXT_TO_SPEECH.speak("Seu tempo acabou vamos para o próximo desafio, o resultado da expressão " +
                                    TXT_NUM_1.getText().toString() + " elevado à 2 " +
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act14.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act14.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa14() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act14.this, ActPausa14.class);
    ...
    private void speakOutNow() {
        ...
        if (btnRepetir.isPressed()) {
            TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é " + TXT_NUM_1.getText().toString() +
                    " elevado à 2 ", TextToSpeech.QUEUE_FLUSH, null);
        }
    }
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act14.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act14.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act14.this, "Erro", "Erro no TextSpeech!");
        }
    }
