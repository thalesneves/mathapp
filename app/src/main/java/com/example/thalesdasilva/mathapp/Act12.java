...
public class Act12 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    private void carregarEstrutura() {
        ...
        if (numeroRandom == 1) {
            TXT_SINAL.setText(String.valueOf(getString(R.string.btnDiv)));
        } else if (numeroRandom == 2) {
            TXT_SINAL.setText(String.valueOf(getString(R.string.btnX)));
        }

        if (TXT_SINAL.getText().toString().equals(getString(R.string.btnDiv))) {
            float numeroRandomico1 = (int) (Math.random() * 10);
            float numeroRandomico2 = (int) (Math.random() * 10);
            ...
            if (numeroRandomico1 % 2 != 0 || numeroRandomico2 % 2 != 0) {
                flag = true;
            } else {
                flag = false;
            }
            ...
            TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString().replace(".0", "") +
                    getString(R.string.btnDiv) +
                    TXT_NUM_2.getText().toString().replace(".0", ""), TextToSpeech.QUEUE_FLUSH, null);

            String RESULTADO_CORRETOTxt = String.format(String.valueOf(DF.format(RESULTADO_CORRETO))).
                    replace(".", ",");
            ...
            if (flag == true) {
                ...
                if (numeroAleatorioParaAEscolhaDeQualBotaoASerPreenchido == 1) {
                    btnResult1.setText(String.valueOf(RESULTADO_CORRETOTxt));
                    ...
                    btnResult2.setText(String.valueOf(RESULTADO_CORRETOTxt));
                    btnResult3.setText(String.valueOf(nRBR3));
                    btnResult4.setText(String.valueOf(nRBR4));
                    ...
                    btnResult1.setText(String.valueOf(nRBR1));
                    btnResult2.setText(String.valueOf(nRBR2));
                    btnResult3.setText(String.valueOf(RESULTADO_CORRETOTxt));
                    btnResult4.setText(String.valueOf(nRBR4));
                    ...
                    btnResult2.setText(String.valueOf(nRBR2));
                    btnResult3.setText(String.valueOf(nRBR3));
                    btnResult4.setText(String.valueOf(RESULTADO_CORRETOTxt));
        ...
        } else if (TXT_SINAL.getText().toString().equals(getString(R.string.btnX))) {
            int numeroRandomico1 = (int) (Math.random() * 10);
            int numeroRandomico2 = (int) (Math.random() * 10);
            ...
            RESULTADO_CORRETO = Float.valueOf(numeroRandomico1 * numeroRandomico2);
            String RESULTADO_CORRETOTxt = String.valueOf(RESULTADO_CORRETO).toString().replace(".0", "");

            TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString().replace(".0", "") +
                    getString(R.string.btnX) +
                    TXT_NUM_2.getText().toString().replace(".0", ""), TextToSpeech.QUEUE_FLUSH, null);
            ...
            if (numeroRandomicoBtnResult2 == numeroRandomicoBtnResult1) {
                numeroRandomicoBtnResult2++;
            } else if (numeroRandomicoBtnResult2 == numeroRandomicoBtnResult3) {
                numeroRandomicoBtnResult2++;
            } else if (numeroRandomicoBtnResult2 == numeroRandomicoBtnResult4) {
            ...
            if (numeroRandomicoBtnResult3 == numeroRandomicoBtnResult1) {
                numeroRandomicoBtnResult3++;
            } else if (numeroRandomicoBtnResult3 == numeroRandomicoBtnResult2) {
                numeroRandomicoBtnResult3++;
            } else if (numeroRandomicoBtnResult3 == numeroRandomicoBtnResult4) {
            ...
            if (numeroRandomicoBtnResult4 == numeroRandomicoBtnResult1) {
                numeroRandomicoBtnResult4++;
            } else if (numeroRandomicoBtnResult4 == numeroRandomicoBtnResult2) {
                numeroRandomicoBtnResult4++;
            } else if (numeroRandomicoBtnResult4 == numeroRandomicoBtnResult3) {
                    ...
                    public void run() {
                        ...
                        if (seconds == 0) {
                            ...
                            if (TXT_SINAL.getText().toString().equals(getString(R.string.btnX))) {
                                ...
                                TEXT_TO_SPEECH.speak("Seu tempo acabou vamos para o próximo desafio, o resultado da expressão " +
                                        TXT_NUM_1.getText().toString() + getString(R.string.btnDiv) + TXT_NUM_2.getText().toString() +
                                        "era de " + String.format(String.valueOf(DF.format(RESULTADO_CORRETO))).
                                        replace(".", ","), TextToSpeech.QUEUE_FLUSH, null);
                            }
