...
public class Act16 extends AppCompatActivity implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    private void recuperandoReferencia() {
        ...
        TXT_NUM_3               = findViewById(R.id.txtNum3);
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            if (TXT_SINAL.getText().toString().equals(getString(R.string.mais))) {
                                TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString() + " dividido por " +
                                                TXT_NUM_2.getText().toString() + " mais " + TXT_NUM_3.getText().toString(),
                                        TextToSpeech.QUEUE_FLUSH, null);
                            } else if (TXT_SINAL.getText().toString().equals(getString(R.string.menos))) {
                                TEXT_TO_SPEECH.speak("Quanto é " + TXT_NUM_1.getText().toString() + " dividido por " +
                                                TXT_NUM_2.getText().toString() + " menos " + TXT_NUM_3.getText().toString(),
                                        TextToSpeech.QUEUE_FLUSH, null);
                            }
                        }
                    }
    ...
    private void carregarEstrutura() {
        ...
        float numeroRandomico1 = (int) (Math.random() * 100);
        float numeroRandomico2 = (int) (Math.random() * 100);
        float numeroRandomico3 = (int) (Math.random() * 100);

        if (numeroRandomico1 > 0f && numeroRandomico1 <= 1f) {
            numeroRandomico1++;
        }

        if (numeroRandomico2 > 0f && numeroRandomico2 <= 1f) {
            numeroRandomico2++;
        }

        if (numeroRandomico3 > 0f && numeroRandomico3 <= 1f) {
            numeroRandomico3++;
        }

        TXT_NUM_1.setText(String.valueOf(numeroRandomico1).replace(".0", ""));
        TXT_NUM_2.setText(String.valueOf(numeroRandomico2).replace(".0", ""));
        TXT_NUM_3.setText(String.valueOf(numeroRandomico3).replace(".0", ""));

        boolean flag = false;

        if (numeroRandomico1 % 2 != 0 || numeroRandomico2 % 2 != 0 || numeroRandomico3 % 2 != 0) {
            flag = true;
        } else {
            flag = false;
        }
        ...
        if (numeroRandom == 1) {
            ...
            RESULTADO_CORRETO = numeroRandomico1 / numeroRandomico2 + numeroRandomico3;
        } else if (numeroRandom == 2) {
            TXT_SINAL.setText(String.valueOf(getString(R.string.menos)));
            RESULTADO_CORRETO = numeroRandomico1 / numeroRandomico2 - numeroRandomico3;
        }

        RESULTADO_CORRETO_TXT = String.format(String.valueOf(df.format(RESULTADO_CORRETO))).
                replace(".", ",");
        ...
        if (flag == true) {
            ...
            if (RESULTADO_CORRETO <= 9) {
                numeroRandomicoBtnResult1 = (float) (Math.random() * 10);
                numeroRandomicoBtnResult2 = (float) (Math.random() * 10);
                numeroRandomicoBtnResult3 = (float) (Math.random() * 10);
                numeroRandomicoBtnResult4 = (float) (Math.random() * 10);
            } else if (RESULTADO_CORRETO <= 99) {
                numeroRandomicoBtnResult1 = (float) (Math.random() * 100);
                numeroRandomicoBtnResult2 = (float) (Math.random() * 100);
                numeroRandomicoBtnResult3 = (float) (Math.random() * 100);
                numeroRandomicoBtnResult4 = (float) (Math.random() * 100);
            } else {
                numeroRandomicoBtnResult1 = (float) (Math.random() * 1000);
                numeroRandomicoBtnResult2 = (float) (Math.random() * 1000);
                numeroRandomicoBtnResult3 = (float) (Math.random() * 1000);
                numeroRandomicoBtnResult4 = (float) (Math.random() * 1000);
            }
            ...
            if (numeroAleatorioParaAEscolhaDeQualBotaoASerPreenchido == 1) {
                btnResult1.setText(String.valueOf(RESULTADO_CORRETO_TXT));
                ...
                btnResult2.setText(String.valueOf(RESULTADO_CORRETO_TXT));
                btnResult3.setText(String.valueOf(nRBR3));
                btnResult4.setText(String.valueOf(nRBR4));
                ...
                btnResult1.setText(String.valueOf(nRBR1));
                btnResult2.setText(String.valueOf(nRBR2));
                btnResult3.setText(String.valueOf(RESULTADO_CORRETO_TXT));
                btnResult4.setText(String.valueOf(nRBR4));
                ...
                btnResult2.setText(String.valueOf(nRBR2));
                btnResult3.setText(String.valueOf(nRBR3));
                btnResult4.setText(String.valueOf(RESULTADO_CORRETO_TXT));
            ...
            int numeroRandomicoBtnResult1 = (int) (Math.random() * 10);
            int numeroRandomicoBtnResult2 = (int) (Math.random() * 10);
            int numeroRandomicoBtnResult3 = (int) (Math.random() * 10);
            int numeroRandomicoBtnResult4 = (int) (Math.random() * 10);

            if (numeroRandomico1 == numeroRandomicoBtnResult1) {
                numeroRandomicoBtnResult1++;
            } else if (numeroRandomico1 == numeroRandomicoBtnResult2) {
                numeroRandomicoBtnResult2++;
            } else if (numeroRandomico1 == numeroRandomicoBtnResult3) {
                numeroRandomicoBtnResult3++;
            } else if (numeroRandomico1 == numeroRandomicoBtnResult4) {
                numeroRandomicoBtnResult4++;
            }

            if (numeroRandomico2 == numeroRandomicoBtnResult1) {
                numeroRandomicoBtnResult1++;
            } else if (numeroRandomico2 == numeroRandomicoBtnResult2) {
                numeroRandomicoBtnResult2++;
            } else if (numeroRandomico2 == numeroRandomicoBtnResult3) {
                numeroRandomicoBtnResult3++;
            } else if (numeroRandomico2 == numeroRandomicoBtnResult4) {
                numeroRandomicoBtnResult4++;
            }

            if (numeroRandomicoBtnResult1 == 0) {
                numeroRandomicoBtnResult1++;
            } else if (numeroRandomicoBtnResult2 == 0) {
                numeroRandomicoBtnResult2++;
            } else if (numeroRandomicoBtnResult3 == 0) {
                numeroRandomicoBtnResult3++;
            } else if (numeroRandomicoBtnResult4 == 0) {
                numeroRandomicoBtnResult4++;
            }
                        ...
                        if (seconds == 0) {
                            ...
                            if (TXT_SINAL.getText().toString().equals(getString(R.string.mais))) {
                                TEXT_TO_SPEECH.speak("Seu tempo acabou vamos para o próximo desafio, o resultado da expressão " +
                                        TXT_NUM_1.getText().toString() + " dividido por " + TXT_NUM_2.getText().toString() +
                                        " mais " + TXT_NUM_3.getText().toString() + "era de " + String.valueOf(RESULTADO_CORRETO_TXT), TextToSpeech.QUEUE_FLUSH, null);
                            } else if (TXT_SINAL.getText().toString().equals(getString(R.string.menos))) {
                                TEXT_TO_SPEECH.speak("Seu tempo acabou vamos para o próximo desafio, o resultado da expressão " +
                                        TXT_NUM_1.getText().toString() + " dividido por " + TXT_NUM_2.getText().toString() +
                                        " menos " + TXT_NUM_3.getText().toString() + "era de " + String.valueOf(RESULTADO_CORRETO_TXT), TextToSpeech.QUEUE_FLUSH, null);
                            }
    ...
    private void verificarBundleExtras() {
        if (getIntent().getExtras() != null) {
            ...
            String pontosAcertos = bundle.getString("TXT_PONTUACAO_ACERTO_ACERTO");
            String pontosErros = bundle.getString("TXT_PONTUACAO_ACERTO_ERRO");
    ...
    private void inicializarBancoSQLite() {
        try {
            database = new DataBase(Act16.this);
...
//            MessageBox.show(Act1.this, "Mensagem", "Conexão criada com sucesso!");
        ...
        if (btnRepetir.isPressed()) {
            if (TXT_SINAL.getText().toString().equals(getString(R.string.mais))) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é " + TXT_NUM_1.getText().toString() +
                        " dividido por " + TXT_NUM_2.getText().toString() + " mais " +
                        TXT_NUM_3.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals(getString(R.string.menos))) {
                TEXT_TO_SPEECH.speak("Repetindo a expressão, quanto é " + TXT_NUM_1.getText().toString() +
                        " dividido por " + TXT_NUM_2.getText().toString() + " menos " +
                        TXT_NUM_3.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        }
    }
        ...
        if (numeroRandom == 1) {
            if (TXT_SINAL.getText().toString().equals(getString(R.string.mais))) {
                TEXT_TO_SPEECH.speak("Infelizmente você errou, o resultado da expressão " +
                        TXT_NUM_1.getText().toString() + " dividido por " + TXT_NUM_2.getText().toString() +
                        " mais " + TXT_NUM_3.getText().toString() + "era de " +
                        String.valueOf(RESULTADO_CORRETO_TXT), TextToSpeech.QUEUE_FLUSH, null);
            } else if (TXT_SINAL.getText().toString().equals(getString(R.string.menos))) {
                TEXT_TO_SPEECH.speak("Infelizmente você errou, o resultado da expressão " +
                        TXT_NUM_1.getText().toString() + " dividido por " + TXT_NUM_2.getText().toString() +
                        " menos " + TXT_NUM_3.getText().toString() + "era de " +
                        String.valueOf(RESULTADO_CORRETO_TXT), TextToSpeech.QUEUE_FLUSH, null);
            }
        } else if (numeroRandom == 2) {
            if (TXT_SINAL.getText().toString().equals(getString(R.string.mais))) {
    ...
    private void verificarTotalErros() {
        ...
        if (totalErros == 1) {
            ...
            Intent it = new Intent(Act16.this, ActGrafico.class);
            startActivity(it);
            finish();
        } else {
            seconds = 30;
    ...
    private void irParaActivityPausa16() {
        ...
        TIMER.cancel();
        Intent it = new Intent(Act16.this, ActPausa16.class);
    ...
    private void salvar() {
        try {
            ...
            MessageBox.show(Act16.this, "Erro", "Erro ao salvar os dados" + e.getMessage());
        }
    }
    ...
    public boolean onKeyLongPress(int keyCode, KeyEvent event) {
        ...
        Intent it = new Intent(Act16.this, ActTreinamento.class);
        startActivity(it);
        finish();
    ...
    public void onInit(int text) {
        if (text == TextToSpeech.SUCCESS) {
            ...
            MessageBox.show(Act16.this, "Erro", "Erro no TextSpeech!");
        }
    }
